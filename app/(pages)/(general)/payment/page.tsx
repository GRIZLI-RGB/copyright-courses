...
export default function PaymentPage() {
	...
	const [iAmOplatil, setIAmOplatil] = useState(false);
			...
			{iAmOplatil ? (
				<div className="text-center font-notoSans max-w-[1025px] mx-auto pb-[5vh]">
					...
					<p className="text-[20px] leading-[150%]">
						<span className="font-medium">Отлично!</span> Ожидайте
						данные для входа на платформу обучения на указанную
						электронную почту вместе с чеком об оплате. <br />
						<br />
						Обычно этот процесс занимает{" "}
						<span className="font-medium">не более 5 минут</span>,
						но иногда время ожидания может доходить до трёх рабочих
						суток.
					</p>
				...
				<div className="max-w-[1220px] mx-auto px-[30px] flex items-start gap-x-[100px] justify-between py-16 font-notoSans">
					...
					<div>
						...
						<p className="text-black/70 text-[12px] mb-[30px]">
							Данная ссылка действительна до {1}, {1}
						</p>
						...
						<div className="font-light px-6 py-[18px] rounded-[8px] border border-veryNegative/50 bg-veryNegative/30 text-veryNegative">
							...
							Не забудьте указать уникальный идентификатор платежа
							в комментариях к заказу, иначе платеж не будет
							получен и обработан нами!
						</div>
					</div>
